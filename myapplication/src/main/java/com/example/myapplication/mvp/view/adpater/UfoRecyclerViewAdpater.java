...
public class UfoRecyclerViewAdpater extends RecyclerView.Adapter<UfoRecyclerViewAdpater.baseview> {

    ArrayList<UfoBean> list;
    Context context;
    private ArrayList<Integer> mHeight;
    public UfoRecyclerViewAdpater(ArrayList<UfoBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull baseview holder, int position) {
        ...
        if(position==2){
            holder.jinggao.setVisibility(View.VISIBLE);
        }

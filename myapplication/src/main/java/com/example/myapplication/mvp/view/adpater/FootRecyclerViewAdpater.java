...
public abstract class FootRecyclerViewAdpater extends RecyclerView.Adapter<FootRecyclerViewAdpater.baseview> {

    ArrayList<FootBean> list;
    Context context;

    public FootRecyclerViewAdpater(ArrayList<FootBean> list, Context context) {
        this.list = list;

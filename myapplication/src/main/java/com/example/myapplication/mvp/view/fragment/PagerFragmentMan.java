...
public class PagerFragmentMan extends BaseFragment<HomePresenter> implements HomeContact.HomeIView {
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.layout_pager_fragment_man, null);
...
//                        Log.e("state",i+"");
        ...
        categoryRecyclerViewAdpater = new CategoryRecyclerViewAdpater(Categorylist, getActivity()) {
            @Override
            public void OnClickListener(CategoryRecyclerViewAdpater.baseview holder, int position) {
                holder.imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        Intent intent = new Intent(getActivity(),GoodsActivity.class);
                        intent.putExtra("title",Categorylist.get(position).getGoods_name());
                        intent.putExtra("image",Api.APP_DOMAIN+Categorylist.get(position).getGoods_img_path());
                        intent.putExtra("id",Api.APP_DOMAIN+Categorylist.get(position).getGoods_id()+"");
